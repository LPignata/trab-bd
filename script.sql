...
CREATE TABLE IF NOT EXISTS `mydb`.`endereco` (
  ...
  `bairro_cidade_cod_cidade` INT NOT NULL,
  `tipo_endereco_cod_tipo_endereco` INT NOT NULL,
  PRIMARY KEY (`cod_endereco`, `bairro_cod_bairro`, `bairro_cidade_cod_cidade`, `tipo_endereco_cod_tipo_endereco`),
  CONSTRAINT `fk_endereco_bairro1`
    FOREIGN KEY (`bairro_cod_bairro` , `bairro_cidade_cod_cidade`)
    REFERENCES `mydb`.`bairro` (`cod_bairro` , `cidade_cod_cidade`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
