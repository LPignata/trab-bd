...
CREATE TABLE IF NOT EXISTS `mydb`.`aluno` (
  ...
  PRIMARY KEY (`mat_aluno`, `cpf_aluno`, `rg_aluno`, `filiacao_cod_filiacao`, `sexo_cod_sexo`, `estado_civil_cod_estado_civil`, `cidade_cod_cidade`, `endereco_cod_endereco`, `telefone_cod_telefone`, `escolaridade_cod_escolaridade`, `cargo_cod_cargo`, `pais_cod_pais`),
